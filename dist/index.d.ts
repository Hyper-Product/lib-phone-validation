...
import { CountryPhoneDataItem } from './lib/utility';
 ...
 */
export default function phone(phoneNumber: string, { country, validateMobilePrefix, strictDetection, customCountryPhoneData, }?: {
    country?: string;
