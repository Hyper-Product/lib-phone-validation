 ...
 */
export declare function findCountryPhoneDataByCountry(country: string, customCountryPhoneData?: CountryPhoneDataItem[]): {
    alpha2: string;
    alpha3: string;
    country_code: string;
    country_name: string;
 ...
 */
export declare function findCountryPhoneDataByPhoneNumber(phoneNumber: string, validateMobilePrefix: boolean, customCountryPhoneData?: CountryPhoneDataItem[]): {
