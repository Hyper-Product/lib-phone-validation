 ...
 */
function findCountryPhoneDataByCountry(country, customCountryPhoneData) {
    // if no country provided, assume it's USA
    if (!country) {
        return (customCountryPhoneData !== null && customCountryPhoneData !== void 0 ? customCountryPhoneData : country_phone_data_1.default).find(countryPhoneDatum => countryPhoneDatum.alpha3 === 'USA') || null;
    }
    if (country.length === 2) {
        return (customCountryPhoneData !== null && customCountryPhoneData !== void 0 ? customCountryPhoneData : country_phone_data_1.default).find(countryPhoneDatum => country.toUpperCase() === countryPhoneDatum.alpha2) || null;
    }
    if (country.length === 3) {
        return (customCountryPhoneData !== null && customCountryPhoneData !== void 0 ? customCountryPhoneData : country_phone_data_1.default).find(countryPhoneDatum => country.toUpperCase() === countryPhoneDatum.alpha3) || null;
    }
    return (customCountryPhoneData !== null && customCountryPhoneData !== void 0 ? customCountryPhoneData : country_phone_data_1.default).find(countryPhoneDatum => country.toUpperCase() === countryPhoneDatum.country_name.toUpperCase()) || null;
}
 ...
 */
function findCountryPhoneDataByPhoneNumber(phoneNumber, validateMobilePrefix, customCountryPhoneData) {
    let exactCountryPhoneData;
    let possibleCountryPhoneData;
    for (const countryPhoneDatum of (customCountryPhoneData !== null && customCountryPhoneData !== void 0 ? customCountryPhoneData : country_phone_data_1.default)) {
